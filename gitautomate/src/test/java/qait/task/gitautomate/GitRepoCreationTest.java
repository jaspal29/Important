...
public class GitRepoCreationTest {
	 String projectName="New_Project143";
  ...
  public void beforeTest() throws IOException, InterruptedException {
	  ...
	  newRepoPage.getLink();
	  StringBuilder Link=new StringBuilder(newRepoPage.getLink());
	  ...
	  ExecuteShellCommand.push(str,"/home/jaspalchandramola/Desktop","NewFolder15");
	  driver.navigate().refresh();
	 Assert.assertTrue(driver.findElement(By.xpath("//*[@id=\"js-repo-pjax-container\"]/div[2]/div[1]/div[5]")).isDisplayed());
